...
int progressnum[128]={0};
int sysGetProgressid(){
	...
	DEBUG('t', "progressnum > 128");
	return -1;
};
void sysDeGetProgressid(int progressid){
	progressnum[progressid] = 0;
};
...
Thread::Thread(char* threadName)
{
	...
	progressid = sysGetProgressid();//linbin add
	userid = progressid;    
	name = threadName;
    stackTop = NULL;
    stack = NULL;
...
Thread::Fork(VoidFunctionPtr func, void *arg)
{
    ...
    //sysDeGetProgressid(progressid);//linbin add
...
// 放弃cpu
//注意：我们禁用中断，以便查看线程
//ready列表的前面，可以切换到它原子的。返回时，我们将中断级别重新设置为
//原始状态，以防在禁用中断的情况下调用我们。
//----------------------------------------------------------------------
